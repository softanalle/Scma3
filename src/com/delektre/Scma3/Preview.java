...
public class Preview extends ViewGroup implements SurfaceHolder.Callback {
    ...
    public void switchCamera(Camera camera) {
        ...
        try {
            ...
            logger.error("Preview.switchCamera(): IOException caused by setPreviewDisplay()", exception);
        }
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        try {
            ...
            logger.debug("Preview.surfaceCreated() IOException caused by setPreviewDisplay()", exception);
        } catch (Exception e) {
            logger.debug("Preview.surfaceCreated() got exception: " + e.toString());
        }
    ...
    public void surfaceChanged(SurfaceHolder holder, int format, int w, int h) {
        logger.debug("Preview.surfaceChanged()");
    ...
    void writeImageToDisc(String filename, byte[] data) {
        logger.debug(TAG + ".writeImageToDisc(" + filename + ", " + data.length + " bytes)");
    ...
    public void savePicture(final String filename) {
        logger.debug("Preview.savePicture(" + filename + ")");

        logger.debug("  camera is null: " + (mCamera == null));
        logger.debug("  preview on: " + isPreview_);
        ...
        try {
            ...
            logger.error(TAG + ".savePicture() -> exception: " + re.toString());
    ...
    public void startPreview() {
        logger.debug("Preview.startPreview");
    ...
    public void stopPreview() {
        logger.debug("Preview.stopPreview");
        if (mCamera != null) {
    ...
    public void releaseCamera() {
        ...
        stopPreview();
        if (mCamera != null) {
            logger.debug("Preview.releaseCamera() does stuff");
            mCamera.release();
            mCamera = null;
        }
    }
